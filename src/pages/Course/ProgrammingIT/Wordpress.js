            ...
            <div className="row">
              <div className="col-lg-8 mb-4">
                ...
                <div className="Master_course_desc">
                  <p className="mb-2">
                    WordPress is the simplest, most popular tools to create your
                    own website or blog for development. In this digital
                    century, WordPress has over 35.2% of all the websites on the
                    Internet. WordPress is an open-source content management
                    system. Anyone can use or modify WordPress software to build
                    web sites. A content management system is basically a tool
                    that makes it easy to manage important aspects of your
                    website – like content – without needing to know anything
                    about programming. Here the preparation is begun from the
                    scratch and guide you to assemble a lovely site utilizing
                    WordPress. We will manage you every single thing like
                    establishment, posting articles, refreshing the page
                    substance, menus and gadgets. We have experienced trainers
                    at Computer Training Institute in Surat who are as of late
                    worked with clients so they understand that what clients
                    need so we give guidance about how to manage clients.
                  </p>
                </div>
                <div className="Master_course_btn mb-4 ">
                  <button className="rounded text-center p-2 px-3">
                    Course Duration{" "}
                    <span style={{ color: "##343f52" }}>4 Months</span>
                  </button>
                  <button className="rounded text-center p-2 px-3">
                    Daily Time{" "}
                ...
                <div class="course-faq mt-5">
                  <div class="accordion accordion-flush" id="faqlist">
                    <div class="faq-item mb-3">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-4 fs-14">
                            ...
                            <li class="pb-2">wordpress developer</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              What is a WordPress and how it different from
                              other CMS?
                            </li>
                            <li class="pb-2">
                              Advantage&rsquo;s of using a WordPress for
                              awebsite
                            </li>
                            <li class="pb-2">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              Searching a theme for different category.
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              Uploading Audio, Video, PDF and Word documents.
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              Adding images and videos to a page.
                            </li>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              The difference between widget and plugin.
                            </li>
                    ...
                    <div class="faq-item mb-3">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            <li class="pb-2">
                              Adding social media to a website.
                            </li>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              How to add keyword, meta description and title.
                            </li>
                            <li class="pb-2">Image optimization</li>
                            <li class="pb-2">
                              Integrating Google Analytics and Google Webmaster
                    ...
                    <div class="faq-item mb-3">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            <li class="pb-2">
                              Modifying footer area.Customizing header area.
                            </li>
                    ...
                    <div class="faq-item mb-3">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            <li class="pb-2">
                              Adding Captcha to log in, contact form and comment
                              form.
                            </li>
                            <li class="pb-2">
                              Add different plugin for security.
                            </li>
                            <li class="pb-2">Change Login URL.</li>
                            <li class="pb-2">
                              Adding limit login attempt and 404 error
                              protection.
                            </li>
                            <li class="pb-2">
                              Protect page content and Images.
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="faq-item mb-3">
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            <li class="pb-2">
                              Installing e-Commerce compatible WordPress theme.
                            </li>
                      ...
                      >
                        <div class="faq-body">
                          <ul class="bullets-point ps-3 fs-14">
                            ...
                            <li class="pb-2">
                              How to take backup and restore it.
                            </li>
                            <li class="pb-2">Different Plugin for backup.</li>
                            <li class="pb-2">
                              Migrating from the local server to live server.
                            </li>
                            <li class="pb-2">
                              Migrating from live server to local server.
                            </li>
                          </ul>
                        </div>
                      </div>
